            ...
            <Container className="mt-5">
                <Row className="mb-4">
                    ...
                    <Col md={6}>
                        <h2>Contact</h2>
                        <p>
                            Experience luxury at our hotel with top-notch
                            facilities and outstanding services. Whether you're
                            traveling for business or leisure, we provide a
                            tranquil and sophisticated environment that
